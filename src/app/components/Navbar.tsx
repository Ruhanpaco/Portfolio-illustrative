        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <button
              ...
              className="md:hidden w-10 h-10 flex items-center justify-center rounded-lg hover:bg-gray-100 transition-colors focus:outline-none"
                ...
                <div className="flex flex-col space-y-4">
                  {navLinks.map((link) => (
                    <Link
                      ...
                      href={link.href}
                      onClick={closeNavbar}
                      className="flex items-center space-x-3 text-lg font-medium hover:text-gray-600 transition-colors p-3 rounded-lg hover:bg-gray-50"
                    >
                      <link.icon size={24} />
